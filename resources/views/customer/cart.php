...
<div class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="book-dashboard.php" class="btn-outline-primary">Continue Shopping</a>
    </div>
                    ...
                    <div class="card cart-item-card mb-3 p-3" id="cart-item-<?php echo $item['cart_item_id']; ?>">
                        <div class="row g-3 align-items-center">
                            ...
                            <div class="col-md-3 col-6">
                                ...
                                <?php
                                    // Set the max quantity based on the service name
                                    $max_qty = 1; // Default
                                    if ($item['service_name'] === 'Premium Mechanical Bull QLD') {
                                        $max_qty = 2;
                                    }
                                ?>
                                <input type="number" 
...
<script>
    ...
    async function sendCartUpdate(cartItemId, quantity) {
        ...
        try {
            ...
            if (data.status === 'success') {
                ...
                if (data.cart_count == 0 && cartItemsContainer) {
                ...
                alert(data.message);
                // ** NEW: If backend rejects, reload to show correct server state **
                location.reload(); 
            }
        } catch (error) {
    ...
    function updateCartItem(inputElement) {
        ...
        let quantity = parseInt(inputElement.value); // Use let
        
        // ** NEW: Enforce the max limit from the input's 'max' attribute **
        const max = parseInt(inputElement.getAttribute('max') || 1); 
        ...
        if (quantity > max) {
            ...
            // Alert the user
            alert("You can only have a maximum of " + max + " of this item.");
        }
        // ** END NEW **

        // This sends the update to the server
