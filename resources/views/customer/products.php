...
$products = [
    1 => ["name" => "Cash Cube", "price" => 599.00, "image" => "assets/images/cash-cube.jpg", "category" => "Promotional Items"],
    2 => ["name" => "Deluxe Cash Cube", "price" => 500.00, "image" => "assets/images/deluxe-cash.jpg", "category" => "Promotional Items"],
    3 => ["name" => "Premium Mechanical Bull QLD", "price" => 1200.00, "image" => "assets/images/premiumbull.jpg", "category" => "Mechanical Rides"],
    4 => ["name" => "Mechanical Surfboard", "price" => 1200.00, "image" => "assets/images/mechanical-surf.jpg", "category" => "Mechanical Rides"],
    5 => ["name" => "Pass the Footy", "price" => 495.00, "image" => "assets/images/footypass.jpeg", "category" => "Sport Games (QLD)"],
    6 => ["name" => "Mega Castle", "price" => 995.00, "image" => "assets/images/jumpcastle.png", "category" => "Slides - Jumping Castles (QLD)"]
];
