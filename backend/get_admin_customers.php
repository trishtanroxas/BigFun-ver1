...
if (isset($_GET['customer_id'])) {
    ...
    try {
        ...
        // ✨ FIX: Added `payment_method` and `reference_code` to the query.
        // This is the crucial change that allows the verification button to appear.
        $bookings_query = "SELECT id, date_event, total_amount, payment_status, payment_method, reference_code FROM orders WHERE user_id = ? ORDER BY date_event DESC";
